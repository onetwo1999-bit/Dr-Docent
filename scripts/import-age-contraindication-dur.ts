/**
 * DUR 연령금기약물 업로드 스크립트
 * 소스: scripts/dur_age_contraindication_dur_utf8.csv
 * 대상: drug_master (item_seq 기준 upsert)
 *
 * 실행: npx tsx scripts/import-age-contraindication-dur.ts
 */
...
const CSV_PATH = path.resolve(__dirname, 'dur_age_contraindication_dur_utf8.csv')
